...
class Content {
    ...
    public function __construct() {
		...
		<!-- wp:block {"ref":3386} /--></div>
		<!-- /wp:column -->
		
		<!-- wp:column {"verticalAlignment":"top","width":"33.33%","backgroundColor":"white","className":"contact-right-sidebar"} -->
		<div class="wp-block-column is-vertically-aligned-top contact-right-sidebar has-white-background-color has-background" style="flex-basis:33.33%"><!-- wp:heading -->
		<h2>Our Location</h2>
		<!-- /wp:heading -->
